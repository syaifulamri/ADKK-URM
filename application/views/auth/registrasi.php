          ...
          <form method="post" action="<?= base_url('auth/registrasi') ?>">
            ...
            <div class="separator">
              <p class="change_link">Sudah punya akun?
                <a href="<?= base_url('auth'); ?>"> Silahkan Masuk </a>
              </p>
              ...
              <div>
                ...
                <p>© 2022 - Aplikasi Diteksi Kerusakan Komputer | Dibuat oleh<a href="https://amrysyaiful.blogspot.com/" target="_blank" rel="noopener noreferrer"> U.M.R</a></p>
              </div>
            </div>
          </form>
        </section>
